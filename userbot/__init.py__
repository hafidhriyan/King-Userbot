...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "__🦁Flicks-Userbot🦁__ **V** ```3.6.1``` **Telah Diaktifkan Oleh Lord Gans**")
    return
...
# ====================================InlineHandler===================================== #
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    "⚡Flicks-Userbot⚡",
                    text="""**Anda Bisa Membuat Flicks Userbot Anda Sendiri Dengan Cara :** [Tekan Disini](t.me/SadRoomsInfo)""",
                    buttons=[
                        [
                            custom.Button.url(
                                "Flicks-Userbot",
