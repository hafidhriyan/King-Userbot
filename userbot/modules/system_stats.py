...
async def redis(alive):
    ...
    await alive.edit("⚡Orang⚡")
    await alive.edit("⚡Paling⚡              👑")
    await alive.edit("⚡Tampan⚡             👑")
    await alive.edit("⚡Xixixixi⚡            👑")
    await alive.edit("⚡Sistem⚡           👑")
    await alive.edit("⚡Alive⚡          👑")
    await alive.edit("⚡Sabar⚡         👑")
    await alive.edit("⚡Bentar⚡        👑")
    await alive.edit("⚡Tunggu Bangsat⚡       👑")
    await alive.edit("⚡Ga Sabaran⚡      👑")
    await alive.edit("🚀Kick⚡        👑")
    await alive.edit("⚡Wkwkwkwk⚡    👑")
    await alive.edit("⚡Gabut⚡   👑")
    await alive.edit("⚡Bangsat⚡  👑")
    await alive.edit("⚡Ingfo⚡ 👑")
    await alive.edit("⚡Keluar⚡👑")
    await alive.edit("⚡Cari👑")
    await alive.edit("⚡Cewe👑⚡")
    await alive.edit("⚡Awokawokawok👑awok⚡")
    await alive.edit("⚡Ganteng👑Dulu⚡")
    await alive.edit("⚡Kek👑Gua⚡")
    await alive.edit("⚡Asekkk👑Kwkwk⚡")
    await alive.edit("⚡Skyzo👑Nih⚡")
    await alive.edit("⚡ 😎😎😎 👑Anjay⚡")
    await alive.edit("⚡Xixixi👑Siapa dulu?⚡")
    await alive.edit("⚡😎😎👑Skyzooo⚡")
    await alive.edit("⚡Anjay👑Skyzo⚡")
    await alive.edit("⚡👑Pokonya Skyzo⚡")
    await alive.edit("👑Paling Ganteng 🥵")
    await alive.edit("😎")
