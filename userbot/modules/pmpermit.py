...
DEF_UNAPPROVED_MSG = (
    f"╔══════ 👑 ══════╗\n      **ROOM CHAT LORD**     \n╚══════ 〠 ══════╝  \n"
    f"⎆ __Halo kawan , saya bot yang menjaga room chat lord {DEFAULTUSER} di mohon jangan melakukan spam , kalau anda melakukan itu OTOMATIS saya akan memblockir anda!__ \n"
    "⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊\n"
    f"⎆**DILARANG SPAM 1/3** \n"
    "⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊\n"
    f"◈ **KING** : {DEFAULTUSER}\n"
    f"◈ **SUPPORT** ⚡️Flicks-Userbot⚡️\n")
# =================================================================
